...
function(c){CE.StyleEditor=can.Construct({myThis:null},{presets:{},presetsMetaField:null,presetsLastIdMetaField:null,privateStyles:{},presetStyles:{},presetsLastId:null,presetDefaultLabel:null,privateMetaField:null,prefixPresetClass:null,prefixPrivateClass:null,privateStylesWrapper:null,presetStylesWrapper:null,presetSaveModal:null,emulateCSSMode:!0,init:function(){CE.StyleEditor.myThis=this;this.initPrivateStyles();this.initPresetStyles();this.initEvents()},initPresetStyles:function(){var a=this;
this.prefixPresetClass=parent.motopressCE.styleEditor["const"].prefixPresetClass;this.presetsLastIdMetaField=parent.CE.Navbar.myThis.presetsLastIdMetaField;this.presetsMetaField=parent.CE.Navbar.myThis.presetsMetaField;this.presetsLastId=parent.motopressCE.styleEditor.presets_last_id;this.presetDefaultLabel=parent.motopressCE.styleEditor["const"].presetDefaultLabel;c.each(parent.motopressCE.styleEditor.presets,function(b,d){a.presetStyles[b]=new CE.ShortcodePresetStyle(b,d.settings,d.css,d.label)})},
initEvents:function(){parent.MP.Editor.onIfr("AfterUpdate",this.proxy("clearPresetsField"))},getPresetsLastId:function(){return this.presetsLastId},incPresetsLastId:function(){this.presetsLastId++;return this.presetsLastId},initPrivateStyles:function(){var a=this;this.prefixPrivateClass=parent.motopressCE.styleEditor["const"].prefixPrivateClass;this.privateMetaField=parent.CE.Navbar.myThis.privatesMetaField;c.each(this.getPrivateStylesMeta(),function(b,d){a.privateStyles[b]=new CE.ShortcodePrivateStyle(b,
d.settings)})},udpatePrivateStylesMeta:function(){this.privateMetaField.val(this.getPrivateStylesString());parent.CE.Save.changeContent()},getPrivateStylesMeta:function(){return c.parseJSON(this.privateMetaField.val())},getPrivateStylesString:function(){var a={};c.each(this.privateStyles,function(b,d){d.isEmpty()||(a[b]={settings:d.getSettings(),css:d.getCSS()})});return JSON.stringify(a)},getPrivateStyleInstance:function(a){a=this.retrievePrivateClass(a);if(""!==a&&this.privateStyles.hasOwnProperty(a))return this.privateStyles[a];
a=this.generatePrivateClass();return this.createPrivateStyle(a)},getPresetStyleInstance:function(a){a=this.retrievePresetClass(a);return this.isExistsPreset(a)?this.presetStyles[a]:null},createPrivateStyle:function(a,b){this.privateStyles[a]=new CE.ShortcodePrivateStyle(a,b);return this.privateStyles[a]},retrievePrivateClass:function(a){a=(new RegExp("(?:^|\\s)+("+this.prefixPrivateClass+"[\\d]+-[\\S]+)(?:$|\\s)+")).exec(a);return null!==a&&2===a.length?a[1]:""},generatePrivateClass:function(){var a=
parent.MP.Utils.uniqid(this.prefixPrivateClass+parent.motopressCE.postID+"-");return this.privateStyles.hasOwnProperty(a)?this.generatePrivateClass():a},getPresetsString:function(){var a={};c.each(this.presetStyles,function(b,d){a[b]={settings:d.getSettings(),css:d.getCSS(),label:d.getLabel()}});return JSON.stringify(a)},getPresetsList:function(a){var b={};c.each(this.presetStyles,function(a,c){b[c.getClassName()]=c.getLabel()});a&&(b=c.extend({"":localStorage.getItem("CENone")},b));return b},getPresetsListSelect2:function(){var a=
[];c.each(this.presetStyles,function(b,d){a.push({id:d.getClassName(),text:d.getLabel()})});return a},generatePresetClassName:function(){return this.prefixPresetClass+this.incPresetsLastId()},createPreset:function(a,b){var d=this.generatePresetClassName();""===a&&(a=this.presetDefaultLabel+this.getPresetsLastId());this.presetStyles[d]=new CE.ShortcodePresetStyle(d,b,void 0,a);this.updatePresetStylesMeta();return this.presetStyles[d]},deletePreset:function(a){this.isExistsPreset(a)&&(this.presetStyles[a]["delete"](),
delete this.presetStyles[a],this.updatePresetStylesMeta());return!0},updatePresetStylesMeta:function(){parent.motopressCE.styleEditor.presets=this.presetStyles;this.presetsLastIdMetaField.val(this.getPresetsLastId());this.presetsMetaField.val(this.getPresetsString());parent.CE.Save.changeContent()},clearPresetsField:function(){this.presetsLastIdMetaField.val("");this.presetsMetaField.val("")},isExistsPreset:function(a){return this.presetStyles.hasOwnProperty(a)},retrievePresetClass:function(a){a=
(new RegExp("(?:^|\\s)+("+this.prefixPresetClass+"[\\d]+)(?:$|\\s)+")).exec(a);return null!==a&&2===a.length?a[1]:""},changePrivateClassToDuplicated:function(a){if(""!==a){var b=CE.StyleEditor.myThis.retrievePrivateClass(a);if(""!==b){var d=CE.StyleEditor.myThis.duplicatePrivateStyle(b);a=a.replace(b,d.getClassName())}}return a},duplicatePrivateStyle:function(a){var b=this.generatePrivateClass();a=this.privateStyles.hasOwnProperty(a)?this.createPrivateStyle(b,this.privateStyles[a].getSettings()):
this.createPrivateStyle(b);this.udpatePrivateStylesMeta();return a},setEmulateCSSMode:function(){this.emulateCSSMode=!0;c.each(this.presetStyles,function(){this.updateStyleTag()});c.each(this.privateStyles,function(){this.updateStyleTag()})},unsetEmulateCSSMode:function(){this.emulateCSSMode=!1;c.each(this.presetStyles,function(){this.updateStyleTag()});c.each(this.privateStyles,function(){this.updateStyleTag()})},isEmulateCSSMode:function(){return this.emulateCSSMode}})}(jQuery),function(c){CE.ImageLibrary=
can.Construct({myThis:null},{frame:null,propertyImage:null,init:function(){CE.ImageLibrary.myThis=this;this.frame=parent.wp.media({id:"motopress-image-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",content:"upload",router:"browse",menu:"default",searchable:!0,filterable:!1,sortable:!1,title:localStorage.getItem("CEImageLibraryText"),button:{text:localStorage.getItem("CEImageLibraryText")},library:{type:"image"},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",this.proxy("onOpen"));
this.frame.on("select",this.proxy("setImage"));this.frame.on("close",this.proxy("onClose"))},onOpen:function(){this.frame.reset();this.propertyImage=CE.Dialog.myThis.element.find('[data-motopress-open-img-lib="1"]');var a=this.propertyImage.control();null!==a.id&&(a=parent.wp.media.attachment(a.id),a.fetch(),this.frame.state().get("selection").add(a))},setImage:function(){var a=this.frame.state().get("selection").models[0].attributes,b="full";a.sizes.hasOwnProperty("medium")?b="medium":a.sizes.hasOwnProperty("thumbnail")&&
(b="thumbnail");var b=a.sizes[b].url,d=this.propertyImage.control();d.set({id:a.id,src:b,full:a.sizes.full.url});d.showTools();d.element.trigger("change");this.propertyImage.removeAttr("data-motopress-open-img-lib")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}})}(jQuery),function(c){CE.Link=can.Construct({myThis:null,
wpLink:null,submitCallback:null,closeCallback:null,inputs:{}},{init:function(){CE.Link.myThis=this;CE.Link.wpLink=parent.wpLink;CE.Link.inputs.submit=c("#wp-link-submit",parent.document);CE.Link.inputs.cancel=c("#wp-link-cancel",parent.document);parent.MP.Utils.version_compare(parent.motopressCE.settings.wp.wordpress_version,"4.2",">=")?(CE.Link.inputs.url=c("#wp-link-url",parent.document),CE.Link.inputs.title=c("#wp-link-text",parent.document),CE.Link.inputs.openInNewTab=c("#wp-link-target",parent.document)):
(CE.Link.inputs.url=c("#url-field",parent.document),CE.Link.inputs.title=c("#link-title-field",parent.document),CE.Link.inputs.openInNewTab=c("#link-target-checkbox",parent.document))},open:function(a,b,d,e){var f={url:!0,title:!0,target:!0};"undefined"!==typeof b&&c.extend(f,b);if("undefined"!=typeof CE.Link.wpLink){CE.Link.submitCallback=d;CE.Link.inputs.submit.off("mousedown.motopress-wplink-submit").on("mousedown.motopress-wplink-submit",this.wpSubmitButtonHandler);CE.Link.inputs.cancel.off("click.motopress-wplink-cancel").on("click.motopress-wplink-cancel",
e);parent.wpActiveEditor=parent.tinyMCE.activeEditor.id;var g=null;CE.Link.wpLink.setDefaultValues=function(){var b=null,d=null;c.isPlainObject(a)?(g=a.href,b="_blank"===a.target?!0:!1,d=a.textarea):(g=a.val(),d=a);if(""===g||"#"===g)g="http://";CE.Link.inputs.url.val(g);CE.Link.inputs.openInNewTab.prop("checked",b);CE.Link.wpLink.textarea=d};CE.Link.wpLink.open();g||(g=c.isPlainObject(a)?a.href:a.val(),CE.Link.inputs.url.val(g));"undefined"===typeof CE.Link.inputs.close&&(CE.Link.inputs.close=c(".ui-dialog-titlebar-close",
parent.document));CE.Link.inputs.close.off("mousedown.motopress-wplink-close").on("mousedown.motopress-wplink-close",e);f.url||CE.Link.inputs.url.closest("div").hide();f.title||CE.Link.inputs.title.closest("div").hide();f.target||CE.Link.inputs.openInNewTab.closest("div").hide();parent.CE.Iframe.myThis.wpLinkCloseCallback(this.onDialogClose)}},wpCancelButtonHandler:function(a){CE.Link.wpLink.close();return!1},wpSubmitButtonHandler:function(a){a=CE.Link.wpLink.getAttrs();if(a.href&&"http://"!=a.href)return CE.Link.submitCallback&&
CE.Link.submitCallback(a),CE.Link.wpLink.close(),!1},onDialogClose:function(){CE.Link.inputs.submit.off("mousedown.motopress-wplink-submit");CE.Link.inputs.cancel.off("click.motopress-wplink-cancel");CE.Link.inputs.close.off("mousedown.motopress-wplink-close");CE.Link.inputs.url.closest("div").show();CE.Link.inputs.title.closest("div").show();CE.Link.inputs.openInNewTab.closest("div").show()}})}(jQuery),function(c){CE.WPGallery=can.Construct({myThis:null},{frame:null,ctrl:null,init:function(){CE.WPGallery.myThis=
this;var a=parent.wp.media,b=a.model.Attachment;a.controller.CEGallery=a.controller.FeaturedImage.extend({defaults:parent._.defaults({id:"motopress-media-library-gallery",title:localStorage.getItem("CEWpGalleryText"),toolbar:"main-insert",filterable:"uploaded",library:a.query({type:"image"}),multiple:"add",editable:!0,priority:60,syncSelection:!1},a.controller.Library.prototype.defaults),updateSelection:function(){var a=this.get("selection"),c=CE.WPGallery.myThis.ctrl.get(),f;""!==c&&-1!==c&&(f=parent._.map(c.split(/,/),
function(a){return b.get(a)}));a.reset(f)}});a.view.MediaFrame.CEGallery=a.view.MediaFrame.Post.extend({createStates:function(){this.states.add([new a.controller.CEGallery])},bindHandlers:function(){a.view.MediaFrame.Select.prototype.bindHandlers.apply(this,arguments);this.on("toolbar:create:main-insert",this.createToolbar,this);parent._.each({content:{embed:"embedContent","edit-selection":"editSelectionContent"},toolbar:{"main-insert":"mainInsertToolbar"}},function(a,b){parent._.each(a,function(a,
d){this.on(b+":render:"+d,this[a],this)},this)},this)},mainInsertToolbar:function(a){var b=this;this.selectionStatusToolbar(a);a.set("insert",{style:"primary",priority:80,text:localStorage.getItem("CEWpGalleryText"),requires:{selection:!0},click:function(){var a=b.state(),d=a.get("selection");b.close();a.trigger("insert",d).reset()}})}});this.frame=new a.view.MediaFrame.CEGallery(parent._.defaults({},{state:"motopress-media-library-gallery",title:localStorage.getItem("CEWpGalleryText"),library:{type:"image"},
multiple:!0}));this.frame.on("open",this.proxy("onOpen"));this.frame.on("close",this.proxy("onClose"));this.frame.on("insert",this.proxy("setImage"))},open:function(a){this.ctrl=a;this.frame.open()},onOpen:function(){var a=this.frame;a.reset();var b=this.ctrl.getArray();if(null!==b){var d=null;b.forEach(function(b){d=parent.wp.media.attachment(b);d.fetch();a.state().get("selection").add(d)})}},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();var a=c(parent.document).find("html, body");
a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)},setImage:function(){var a=[],b=this.frame.state().get("selection").models;c.each(b,function(b,c){a.push(c.attributes.id)});this.ctrl.set(a);this.ctrl.element.trigger("change")}})}(jQuery),function(c){CE.Dialog=can.Construct({myThis:null},{dialogClass:"motopress-dialog",element:c("<div />",{id:"motopress-dialog"}),shortcode:null,oldShortcode:null,dialog:null,minimizeRestoreBtn:c("<button />",
{"class":"ui-dialog-titlebar-minimize"}),state:{minimized:"minimized",restored:"restored"},tabs:c("<div />",{id:"motopress-dialog-tabs"}),settingsTitle:c("<li />"),styleTitle:c("<li />"),settingsTab:c("<div />",{id:"motopress-dialog-settings-tab"}),styleTab:c("<div />",{id:"motopress-dialog-style-tab"}),styleEditorContainer:c("<div />",{id:"motopress-style-editor-container","class":"motopress-hide"}),mode:"tabs",setup:function(){var a=c("<ul />");c("<a />",{href:"#"+this.settingsTab.attr("id"),"class":"motopress-text-no-color-text",
text:localStorage.getItem("CESettings")}).append(c("<i />",{"class":"motopress-settings-icon"})).appendTo(this.settingsTitle);c("<a />",{href:"#"+this.styleTab.attr("id"),"class":"motopress-text-no-color-text",text:localStorage.getItem("CEStyle")}).append(c("<i />",{"class":"motopress-style-icon"})).appendTo(this.styleTitle);a.append(this.settingsTitle,this.styleTitle);this.tabs.append(a,this.settingsTab,this.styleTab).appendTo(this.element);this.styleEditorContainer.appendTo(this.element);this.element.appendTo("body")},
setMode:function(a){switch(a){case "tabs":this.styleEditorContainer.addClass("motopress-hide");this.tabs.removeClass("motopress-hide");break;case "style-editor":this.tabs.addClass("motopress-hide"),this.styleEditorContainer.removeClass("motopress-hide")}this.mode=a;this.updateTitle()},updateTitle:function(){var a=this.shortcode.control();switch(this.getMode()){case "tabs":this.setTitle(a.shortcodeLabel);break;case "style-editor":var b=this.styleEditorContainer.children().control();this.setTitle(a.shortcodeLabel+
" - "+b.getTitle())}},getMode:function(){return this.mode},init:function(){CE.Dialog.myThis=this;var a=null,b=!1,d=0,e=parent.MP.Utils.version_compare(c.fn.jquery,"1.9.0","<"),f=sessionStorage.getItem("motopressDialogLeft"),g=sessionStorage.getItem("motopressDialogTop"),f=null!==f&&null!==g?[parseInt(f),parseInt(g)]:{my:"right-20 top+20",at:"right top",of:window},g=sessionStorage.getItem("motopressDialogWidth"),l=sessionStorage.getItem("motopressDialogHeight");null===g&&(g=300);null===l&&(l=500);
c.ui.dialog.prototype._focusTabbable=function(){};this.element.dialog({autoOpen:!1,closeOnEscape:!0,closeText:"",dialogClass:this.dialogClass,draggable:!0,modal:!1,position:f,resizable:!0,minWidth:280,width:g,minHeight:280,height:l,maxHeight:c(window).height(),create:function(){CE.Dialog.myThis.dialog=CE.Dialog.myThis.element.dialog("widget");a=CE.Dialog.myThis.dialog;a.on("resizestart",function(a,f){b=c(a.originalEvent.target).hasClass("ui-resizable-n");d=c(document).scrollTop();e&&(b||c(this).css("top",
parseInt(c(this).css("top"))-d))});a.on("resize",function(a,f){e&&b&&c(this).css("top",parseInt(c(this).css("top"))-d)});a.on("resizestop",function(a,b){CE.Dialog.myThis.savePosition(b);CE.Dialog.myThis.saveSize(b)});c(this).prev(".ui-dialog-titlebar").find(".ui-dialog-titlebar-close").before(CE.Dialog.myThis.minimizeRestoreBtn);var f=a.draggable("option","cancel")+", .ui-dialog-titlebar-minimize, .ui-dialog-titlebar-restore";a.draggable("option","cancel",f);CE.Dialog.myThis.minimizeRestoreBtn.on("click",
function(){c(this).hasClass("ui-dialog-titlebar-minimize")?CE.Dialog.myThis.minimize():CE.Dialog.myThis.restore()})},dragStart:function(a,b){CE.LeftBar.myThis.disable()},dragStop:function(a,b){CE.Dialog.myThis.savePosition(b);CE.LeftBar.myThis.enable()},close:function(){CE.Dialog.myThis.close()},beforeClose:function(a,b){},open:function(){var b=c("."+CE.Selectable.myThis.selectedClass);b.length&&CE.Selectable.focusWithoutScroll(b.prev());var b=parseInt(sessionStorage.getItem("motopressDialogLeft")),
d=parseInt(sessionStorage.getItem("motopressDialogTop")),e=a.width(),f=a.height(),g=c(window).width(),l=c(window).height();f>l&&(f=l,a.height(f));0>d?a.css("top",0):f<l&&d+f>l?a.css("top",l-f):d+f>l?a.css("top",l-f):a.css("top",d);0>b?a.css("left",0):e<g&&b+e>g?a.css("left",g-e):a.css("left",b)},resizeStart:function(){CE.LeftBar.myThis.disable()},resizeStop:function(){CE.LeftBar.myThis.enable()}});c(parent.window).on("resize.CE.Dialog",this.proxy("onResize"));parent.MP.Utils.fixTabsBaseTagConflict(this.tabs,
document,location);this.tabs.tabs({activate:function(a,b){CE.Dialog.myThis.shortcode.attr("data-motopress-dialog-tab",b.newTab.index())}})},_destroy:function(){c(parent.window).off("resize.CE.Dialog")},onResize:function(){this.element.dialog("option","maxHeight",c(window).height())},open:function(a){this.oldShortcode=this.shortcode;a.hasClass("motopress-clmn-select-handle")?this.shortcode=a.closest(".motopress-clmn"):a.hasClass("motopress-row-select-handle")?this.shortcode=a.closest(".motopress-row"):
this.shortcode=a.closest(".motopress-clmn").find(".motopress-block-content").first().children("[data-motopress-shortcode]");var b=!1;"undefined"!==typeof this.shortcode&&this.shortcode&&this.shortcode.length&&"undefined"!==typeof this.oldShortcode&&this.oldShortcode&&this.oldShortcode.length&&this.shortcode[0]===this.oldShortcode[0]&&(b=!0);var d=this.shortcode.control(CE.Controls);if(null!==CE.LeftBar.myThis.library&&"undefined"!==typeof d.group&&"undefined"!==typeof d.shortcodeName&&CE.LeftBar.myThis.library[d.group].objects.hasOwnProperty(d.shortcodeName)){a=
c.isEmptyObject(CE.LeftBar.myThis.library[d.group].objects[d.shortcodeName].parameters);var e=this.isGrid?"gridProps":"props";a&&c.isEmptyObject(CE.Style[e])||(this.setTitle(d.shortcodeLabel),e=!1,this.shortcode.hasClass("motopress-new-object")&&(e=!0,this.shortcode.removeClass("motopress-new-object")),b||d.display(e),sessionStorage.getItem("motopressDialogState")===this.state.minimized?this.minimize():this.restore(),b=a?this.styleTitle.index():this.settingsTitle.index(),d=this.shortcode.attr("data-motopress-dialog-tab"),
"undefined"!==typeof d&&(b=d),a?this.tabs.tabs("disable",this.settingsTitle.index()):!1!==this.tabs.tabs("option","disabled")&&this.tabs.tabs("enable",this.settingsTitle.index()),this.tabs.tabs("option","active",b),this.element.dialog("open"),this.element.find(".motopress-controls").trigger("dialogOpen"))}},close:function(){"style-editor"===this.getMode()&&this.styleEditorContainer.children().control().confirm();this.setTitle();var a=c("."+CE.Selectable.myThis.selectedClass);a.length&&CE.Selectable.focusWithoutScroll(a.prev())},
setTitle:function(a){a="undefined"!==typeof a?a:"";"string"===typeof a&&(this.element.dialog("option","title",a),this.element.dialog("widget").find(".ui-dialog-title").attr("title",a))},savePosition:function(a){sessionStorage.setItem("motopressDialogLeft",this.dialog.css("left"));sessionStorage.setItem("motopressDialogTop",this.dialog.css("top"))},saveSize:function(a){sessionStorage.setItem("motopressDialogWidth",a.size.width);sessionStorage.setItem("motopressDialogHeight",a.size.height)},minimize:function(){this.minimizeRestoreBtn.removeClass("ui-dialog-titlebar-minimize").addClass("ui-dialog-titlebar-restore");
sessionStorage.setItem("motopressDialogState",this.state.minimized);this.element.nextAll().add(this.element).addClass("motopress-hide");this.dialog.removeClass("motopress-dialog-"+this.state.restored).addClass("motopress-dialog-"+this.state.minimized)},restore:function(){this.minimizeRestoreBtn.removeClass("ui-dialog-titlebar-restore").addClass("ui-dialog-titlebar-minimize");sessionStorage.setItem("motopressDialogState",this.state.restored);this.element.nextAll().add(this.element).removeClass("motopress-hide");
this.dialog.removeClass("motopress-dialog-"+this.state.minimized).addClass("motopress-dialog-"+this.state.restored)}})}(jQuery),function(c){CE.WPMedia=can.Construct({myThis:null},{frame:null,propertyMedia:null,init:function(){CE.WPMedia.myThis=this;this.frame=parent.wp.media({id:"motopress-media-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",content:"upload",router:"browse",menu:"default",searchable:!0,filterable:!1,sortable:!1,title:localStorage.getItem("CEMediaLibraryText"),
button:{text:localStorage.getItem("CEMediaLibraryText")},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",this.proxy("onOpen"));this.frame.on("select",this.proxy("setMedia"));this.frame.on("close",this.proxy("onClose"))},onOpen:function(){var a;this.propertyMedia=CE.Dialog.myThis.element.find("[data-motopress-open-media-lib=1]");this.propertyMediaID=this.propertyMedia.find(".motopress-property-media-id");this.propertyMediaSrc=this.propertyMedia.find(".motopress-property-media");a=this.propertyMediaID.val();
a=null!==a?parent.wp.media.attachment(a):parent.wp.media.attachment();a.fetch();this.frame.state().get("selection").add(a)},setMedia:function(){var a=this.frame.state().get("selection").models[0].attributes,b=this.propertyMedia.control(),d=a.url;this.propertyMediaID.val(a.id);this.propertyMediaSrc.val(d);b.element.removeAttr("data-motopress-open-media-lib");b.element.trigger("change")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();this.propertyMedia.removeAttr("data-motopress-open-media-lib");
var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}});CE.WPAudio=can.Construct({myThis:null},{frame:null,propertyAudio:null,propertyAudioTitle:null,init:function(){CE.WPAudio.myThis=this;this.frame=parent.wp.media({id:"motopress-audio-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",content:"upload",router:"browse",menu:"default",searchable:!0,filterable:!1,
sortable:!1,title:"Set audio file",button:{text:"Set audio file"},library:{type:"audio"},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",this.proxy("onOpen"));this.frame.on("select",this.proxy("setAudio"));this.frame.on("close",this.proxy("onClose"))},onOpen:function(){var a;this.propertyAudio=CE.Dialog.myThis.element.find(".motopress-property-audio-id");this.propertyAudioTitle=CE.Dialog.myThis.element.find(".motopress-property-audio-title");a=this.propertyAudio.val();a=null!==a?parent.wp.media.attachment(a):
parent.wp.media.attachment();a.fetch();this.frame.state().get("selection").add(a)},setAudio:function(){var a=this.frame.state().get("selection").models[0].attributes;this.propertyAudio.val(a.id);this.propertyAudioTitle.val(a.title);this.propertyAudio.trigger("change")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},
0)}});CE.WPVideo=can.Construct({myThis:null},{frame:null,propertyVideo:null,init:function(){CE.WPVideo.myThis=this;this.frame=parent.wp.media({id:"motopress-video-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",content:"upload",router:"browse",menu:"default",searchable:!0,filterable:!1,sortable:!1,title:localStorage.getItem("CEVideoLibraryText"),button:{text:localStorage.getItem("CEVideoLibraryText")},library:{type:"video"},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",
this.proxy("onOpen"));this.frame.on("select",this.proxy("setVideo"));this.frame.on("close",this.proxy("onClose"))},onOpen:function(){this.propertyVideo=CE.Dialog.myThis.element.find("[data-motopress-open-video-lib=1]")},setVideo:function(){var a=this.frame.state().get("selection").models[0].attributes.url,b=this.propertyVideo.control();b.set(a);b.element.removeAttr("data-motopress-open-video-lib");b.element.trigger("change")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();this.propertyVideo.removeAttr("data-motopress-open-video-lib");
var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}})}(jQuery),function(c){CE.Style=can.Construct({gridProps:null,props:{mp_custom_style:{type:"style_editor",label:localStorage.getItem("CECustomStyle"),description:localStorage.getItem("CECustomStyleDesc"),parameters:{"background-color":{type:"color-picker",label:localStorage.getItem("CEBgColor"),"default":""},color:{type:"color-picker",
...
d,this.getPresetStateAttrs("up"),this.getPresetStateAttrs("hover"),this.getPrivateStateAttrs("up"));break;case "tablet":c.extend(b,d,this.getPresetStateAttrs("up"),this.getPresetStateAttrs("tablet"),this.getPrivateStateAttrs("up"));break;case "mobile":c.extend(b,d,this.getPresetStateAttrs("up"),this.getPresetStateAttrs("tablet"),this.getPresetStateAttrs("mobile"),this.getPrivateStateAttrs("tablet"),this.getPrivateStateAttrs("up"))}return b},clear:function(){this.editedStyleObj.clear();this.resetForm()},
getTitle:function(){var a="Element Style";null!==this.presetStyleObj&&(a+=" (inherit from "+this.presetStyleObj.getLabel()+")");return a},show:function(){this._super()},hide:function(){this._super()}})}(jQuery),function(c){CE.StyleEditorControlsForm("CE.PresetStyleControlsForm",{},{generateActionButtons:function(){var a=this,b=this._super(),d=[c("<a />",{href:"#","class":"motopress-ce-style-editor-rename-button",text:localStorage.getItem("CERename")}).on("click",function(b){b.preventDefault();a.renamePreset()}),
c("<a />",{href:"#","class":"motopress-ce-style-editor-delete-button",text:localStorage.getItem("CEDelete")}).on("click",function(b){b.preventDefault();a.deletePreset()})];return c.merge(d,b)},getGeneralAttrs:function(){return CE.Style.getStyleEditorProps()},getAttrs:function(){return this.editedStyleObj.getSettings()},getStateAttrs:function(a){var b={};switch(a){case "up":c.extend(b,this.editedStyleObj.getStateSettings("up"));break;case "hover":c.extend(b,this.editedStyleObj.getStateSettings("up"),
this.editedStyleObj.getStateSettings("hover"));break;case "tablet":c.extend(b,this.editedStyleObj.getStateSettings("up"),this.editedStyleObj.getStateSettings("tablet"));break;case "mobile":c.extend(b,this.editedStyleObj.getStateSettings("up"),this.editedStyleObj.getStateSettings("tablet"),this.editedStyleObj.getStateSettings("mobile"))}return b},getInheritValues:function(a){var b={},d=this.getEmptyValues();switch(a){case "up":c.extend(b,d);break;case "hover":c.extend(b,d,this.editedStyleObj.getStateSettings("up"));
break;case "tablet":c.extend(b,d,this.editedStyleObj.getStateSettings("up"));break;case "mobile":c.extend(b,d,this.editedStyleObj.getStateSettings("up"),this.editedStyleObj.getStateSettings("tablet"))}return b},renamePreset:function(a,b){var c=localStorage.getItem("CERenamePresetPrompt").replace("%presetLabel%",this.editedStyleObj.getLabel()),c=prompt(c,this.editedStyleObj.getLabel());null!==c&&(c=c.trim(),""!==c?(this.editedStyleObj.updateLabel(c),CE.Dialog.myThis.updateTitle(),this.styleEditorCtrl.refresh()):
(parent.MP.Flash.setFlash(localStorage.getItem("CERenamePresetEmptyError"),"error"),parent.MP.Flash.showMessage()))},deletePreset:function(a,b){var c=localStorage.getItem("CEDeletePresetConfirm").replace("%presetLabel%",this.editedStyleObj.getLabel());confirm(c)&&(CE.StyleEditor.myThis.deletePreset(this.editedStyleObj.getClassName()),this.styleEditorCtrl.refresh(),this.hide())},getTitle:function(){return'Preset "'+this.editedStyleObj.getLabel()+'"'}})}(jQuery),function(c){CE.ControlsForm("CE.ControlsSubForm",
{},{parentPropertyCtrl:null,init:function(a,b){this.parentPropertyCtrl=b.parentPropertyCtrl;this._super(a,b)},getGeneralAttrs:function(){return this.parentPropertyCtrl.getParameters()},getAttrs:function(){return{}},save:function(){this.parentPropertyCtrl.element.trigger("change")},display:function(a){var b=this;a=this.getGeneralAttrs();var d;c.each(a,function(a,c){d=b.getParameterElByName(a);d.trigger("customize")})},changeProperty:function(a){this.save()},set:function(a){var b=this.getGeneralAttrs(),
d,e,f=this;c.each(b,function(b,c){d=f.getCtrlByName(b);e=a.hasOwnProperty(b)?a[b]:"";d.set(e)});this.resolveDependencies()},get:function(){var a,b,d={},e=this,f=this.getGeneralAttrs();c.each(f,function(c,f){a=e.getCtrlByName(c);a.isHided()||(b=a.get(),d[c]=b)});return d}})}(jQuery),function(c){CE.Shortcode("CE.Controls",{},{settingsForms:null,styleForms:null,settingsCtrl:null,stylesCtrl:null,isNew:!1,init:function(a,b){this._super(a,b);this.isNew=b.isNew;this.settingsForms=c("<div />",{"class":"motopress-settings-forms"});
this.settingsCtrl=new CE.SettingsControlsForm(this.settingsForms,{formsMainCtrl:this});this.styleForms=c("<div />",{"class":"motopress-style-forms"});this.stylesCtrl=new CE.StyleControlsForm(this.styleForms,{formsMainCtrl:this})},render:function(a){if(!this.isGrid){if(a||"undefined"===typeof a)CE.Resizer.myThis.updateBottomInHandleMiddle(),CE.Resizer.myThis.updateHandle(),CE.Resizer.myThis.updateHandleMiddle();CE.Resizer.myThis.updateSplitterHeight(this.element,"render");this.shortcode.find("a").attr("tabindex",
-1)}},renderShortcode:function(a){if(!this.isGrid){switch(typeof a){case "undefined":a="updated";break;case "boolean":a=a?"created":"updated"}var b=this,d=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class"));d.addClass(CE.Shortcode.preloaderClass);var e=this.element.attr("data-motopress-close-type"),f="undefined"!==typeof this.element.attr("data-motopress-wrap-render")?this.element.attr("data-motopress-wrap-render"):
null,g="undefined"!==typeof this.element.attr("data-motopress-parameters")?this.element.attr("data-motopress-parameters"):null,l="undefined"!==typeof this.element.attr("data-motopress-styles")?this.element.attr("data-motopress-styles"):null;"created"===a&&g&&(g=this.settingsCtrl.setDefaultAttrs(g));"created"===a&&l&&(l=this.stylesCtrl.setDefaultAttrs(l));var h="undefined"!==typeof this.element.attr("data-motopress-content")?this.element.attr("data-motopress-content").replace(/\[\]/g,"["):null;"undefined"!==
typeof this.element.attr("data-motopress-active-item")&&(g=c.parseJSON(g),g[this.activeParameter]={value:this.element.attr("data-motopress-active-item")},g=JSON.stringify(g));c.ajax({url:parent.motopress.ajaxUrl,type:"POST",dataType:"html",data:{action:"motopress_ce_render_shortcode",nonce:parent.motopressCE.nonces.motopress_ce_render_shortcode,postID:parent.motopressCE.postID,closeType:e,shortcode:b.shortcodeName,wrapRender:f,parameters:g,styles:l,content:h},success:function(e){var f=c(e).find(".motopress-ce-private-styles-updates-wrapper").andSelf().filter(".motopress-ce-private-styles-updates-wrapper").children("style");
CE.ShortcodePrivateStyle.addRenderedStyleTags(f);e=c(e).find(".motopress-ce-rendered-content-wrapper").andSelf().filter(".motopress-ce-rendered-content-wrapper").children();f=b.element.closest(".motopress-clmn");if(!f.closest(".motopress-row").parent(".motopress-content-wrapper").length){var f=f.closest(".motopress-row").nextAll(".motopress-handle-middle-in:last"),g=parseInt(f.css("min-height"));f.height(g)}c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height("");b.element.html(e);
b.child=CE.Shortcode.getChild(b.shortcode);e=b.shortcode.find("img");var h=e.length,l=0;if(h)e.on("load",function(){l++;l===h&&b.element.trigger("render")});e=CE.LeftBar.myThis.getParametersAttrs(b.group,b.shortcodeName);var r;b.groupItemName&&(r=b.settingsForms.find(".motopress-property-group").control(),e=e[b.groupItemName],"created"===a&&(e.hasOwnProperty("items")&&e.items.hasOwnProperty("count")&&0<e.items.count&&b.settingsForms.find('> [data-motopress-parameter="'+b.groupItemName+'"] > .motopress-property-group > .motopress-property-button-wrapper > .motopress-property-button-default').trigger("click",
e.items.count),r.dependency&&b.settingsForms.find('[data-motopress-parameter="'+r.dependency.parameter+'"] .motopress-controls').trigger("change",!1)),r.reassignShortcodes());"duplicated"===a||"created"===a?c("body").trigger("MPCEObjectCreated",[b.element,b.shortcodeName]):c("body").trigger("MPCEObjectUpdated",[b.element,b.shortcodeName]);b.element.trigger("render");d.removeClass(CE.Shortcode.preloaderClass);parent.CE.Save.changeContent();b.groupItemName&&r.accordion.hasClass("ui-accordion")&&(e=
r.accordion.accordion("option","active"),r.interact("activate",e))},error:function(a){a=c.parseJSON(a.responseText);a.debug?console.log(a.message):(parent.MP.Flash.setFlash(a.message,"error"),parent.MP.Flash.showMessage());d.removeClass(CE.Shortcode.preloaderClass)}})}},display:function(a){this.settingsCtrl.display(a);this.stylesCtrl.display(a)}})}(jQuery),function(c){CE.Controls("CE.InlineEditor",{curElement:null,styleFormats:!1,init:function(){c(document).on("mousedown",".mce-tinymce.mce-panel",
function(a){a.preventDefault()});c(document).on("keydown",'[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]',function(a){a.which===c.ui.keyCode.TAB?CE.Selectable.myThis.unselect():a.which===c.ui.keyCode.ESCAPE&&(CE.InlineEditor.curElement&&CE.InlineEditor.curElement.control().close(!0,"show"),a=c(this).closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class")),CE.Selectable.focusWithoutScroll(a.prev()),
CE.Dialog.myThis.element.dialog("isOpen")||CE.Dialog.myThis.open(a))});c(parent.document).on("mousedown",function(a){CE.InlineEditor.curElement&&!c(a.target).closest(".ui-dialog").length&&CE.InlineEditor.curElement.control().close(!0,"show")})},isTinymce:function(a){var b=!1;c(a.target).hasClass("motopress-drag-handle")||(a=c(a.currentTarget.activeElement),a.length&&(a.closest("[data-motopress-shortcode]").length||a.closest(".mce-tinymce").length||a.closest(".mce-window").length||a.closest(".mce-popover").length)&&
(b=!0));return b},destroyAll:function(){var a;parent.CE.Iframe.myThis.sceneContent.find('[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]').each(function(){a=c(this).control();a.destroyEditor()})},reinitAll:function(){var a;parent.CE.Iframe.myThis.sceneContent.find('[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]').each(function(){a=c(this).control();a.initEditor()})}},{id:null,isOpen:!1,editor:null,helpers:null,blockContent:null,floatpanel:null,
saved:!1,init:function(a,b){this._super(a,b);this.id=parent.MP.Utils.uniqid();this.blockContent=this.element.parent("."+CE.DragDrop.myThis.blockContent.attr("class"));var c=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first();this.helpers=c.add(c.children().not(".motopress-splitter, .motopress-clmn-select-handle"));this.resizers=this.blockContent.nextAll(".ui-resizable-handle");c.children("."+CE.DragDrop.myThis.dragHandle.attr("class")).on("click",this.proxy("onClick"))},
destroy:function(){CE.InlineEditor.curElement=null;this.floatpanel&&this.floatpanel.remove();this._super()},initEditor:function(){var a=this,b=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class")),d=setTimeout(function(){var e="bold italic underline | ";c.isEmptyObject(CE.InlineEditor.styleFormats)||(e+="styleselect | ");tinyMCE.init({selector:"#"+a.id,inline:!0,plugins:"link hr textcolor",visual:!1,
convert_urls:!1,menubar:!1,toolbar:e+"formatselect | fontsizeselect forecolor | alignleft aligncenter alignright alignjustify | numlist bullist outdent indent | link unlink hr removeformat",fontsize_formats:"8px 9px 10px 11px 12px 13px 14px 15px 16px 18px 24px 30px 36px 42px 48px 60px 72px 96px",language:parent.MP.Settings.lang.tinymce,skin:"motopresscontenteditor",browser_spellcheck:parent.MP.Settings.spellcheck,style_formats_merge:!1,style_formats:CE.InlineEditor.styleFormats,setup:function(d){a.editor=
d;d.on("loadContent",function(){a.autoOpen(b,1)});d.on("execCommand",function(b){switch(b.command){case "mceToggleEditor":if(!a.floatpanel&&(b=c("body").children(".mce-floatpanel:last"),b.length&&(a.floatpanel=b,50<b.height()))){var d=b.find('.mce-container-body.mce-flow-layout > [role="toolbar"]:first').outerHeight(!0)-2;b.width(723).height(d);b.children(".mce-container-body.mce-abs-layout").width(723).height(d).children(".mce-container.mce-panel").width(723).height(d).children(".mce-container-body.mce-stack-layout").width(723).height(d)}a.floatpanel.offset().left+
a.floatpanel.width()>c(window).width()&&(b=a.element.offset().left+a.element.width()-a.floatpanel.width(),a.floatpanel.css("left",b))}})},init_instance_callback:function(d){c.each(d.menuItems.formats.menu,function(a,b){"Blocks"===b.text&&c.each(b.menu,function(a,c){"Div"===c.text&&delete b.menu[a]})});c(d.getBody()).on("blur",function(){a.save()});c(d.getBody()).on("focus",function(){a.saved=!1;if(b.hasClass(CE.Selectable.myThis.selectedClass))b.trigger("click");else var c=setTimeout(function(){CE.LeftBar.myThis.leftBar.focus();
clearTimeout(c)},0)})}});clearTimeout(d)},0)},destroyEditor:function(){this.editor.destroy();this.editor=null}," render":function(){this.shortcode.children("div").attr("id",this.id);this.initEditor()},onClick:function(a){c(a.target).hasClass(CE.Selectable.myThis.selectedClass)&&!this.isOpen&&(this.isOpen=!0,CE.InlineEditor.curElement=this.element,CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close"),this.helpers.hide(),c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height(""),
this.resizers.hide(),this.blockContent.addClass("motopress-overflow-visible-important"),this.editor.execCommand("mceToggleEditor",!1),this.showHideFloatpanel("show"))},close:function(a,b){this.isOpen&&(this.isOpen=!1,this.save(),this.helpers.show(),"undefined"!==typeof a&&("show"===b?this.resizers.show():"hide"===b&&this.resizers.hide()),this.showHideFloatpanel("hide"),this.blockContent.removeClass("motopress-overflow-visible-important"),CE.Resizer.myThis.updateHandle(),parent.CE.Save.changeContent())},
save:function(){this.saved||(this.shortcode.attr("data-motopress-content",this.editor.getContent({format:"html"})),this.saved=!0,CE.Resizer.myThis.updateBottomInHandleMiddle(),CE.Resizer.myThis.updateSplitterHeight(this.element,"split"),CE.Resizer.myThis.updateHandleMiddle())},autoOpen:function(a,b){if(3>=b)if(1<b&&a.hasClass(CE.Selectable.myThis.selectedClass))CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close"),c(this.editor.getBody()).trigger("blur").trigger("focus"),
a.trigger("click");else var d=this,e=setTimeout(function(){d.autoOpen(a,b+1);clearTimeout(e)},500)},showHideFloatpanel:function(a){this.floatpanel&&("show"===a?this.floatpanel.show():this.floatpanel.hide())}})}(jQuery),function(c){CE.Controls("CE.CodeEditor",{},{init:function(a,b){this._super(a,b);var c=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class"));this.autoOpen(c,1);c.on("click",this.proxy("onClick"))},
destroy:function(){this._super()}," render":function(){this.shortcode.find(".row").removeClass("row").addClass(parent.CE.Iframe.myThis.gridObj.row["class"]);this.shortcode.find("a").attr("tabindex",-1);CE.Resizer.myThis.updateAllHandles()},autoOpen:function(a,b){if(3>=b)if(1<b&&a.hasClass(CE.Selectable.myThis.selectedClass))a.trigger("click");else var c=this,e=setTimeout(function(){c.autoOpen(a,b+1);clearTimeout(e)},500)},onClick:function(a){if(c(a.target).hasClass(CE.Selectable.myThis.selectedClass)){a=
parent.CE.CodeModal.myThis.editor;parent.CE.CodeModal.currentShortcode=this.element;var b=this.shortcode.attr("data-motopress-content");"undefined"!==typeof b&&(b=b.replace(RegExp("\\[\\]","ig"),"["),null!==a&&a.setContent(b,{format:"html"}),parent.CE.CodeModal.myThis.content.val(parent.switchEditors._wp_Nop(b)));parent.CE.CodeModal.myThis.saveHandler=this.saveHandler;parent.CE.CodeModal.myThis.element.mpmodal("show")}},saveHandler:function(a){a=parent.CE.CodeModal.myThis;a.switchVisual();var b=parent.CE.CodeModal.currentShortcode.control(),
c=null!==a.editor?a.editor.getContent({format:"html"}):parent.switchEditors._wp_Autop(a.content.val());c.length?b.shortcode.attr("data-motopress-content",c):b.shortcode.removeAttr("data-motopress-content");b.renderShortcode();a.element.mpmodal("hide")}})}(jQuery),function(c){CE.Tools=can.Construct({myThis:null},{init:function(){CE.Tools.myThis=this},removeBlock:function(){CE.Utils.removeSceneAction("select");var a=c(".motopress-selected").closest(".motopress-clmn"),b=a.closest(".motopress-row");CE.Selectable.setScrollY(window.scrollY);
CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close");parent.CE.Navbar.myThis.hideObjectControlBtns();var d=a.siblings(".motopress-clmn"),e=parent.MP.Utils.getSpanClass(a.prop("class").split(" ")),e=CE.DragDrop.myThis.removeEmptyBlocks(a,e),e=b.children(".motopress-clmn").index(a),e=CE.DragDrop.myThis.canBeMoved(b,null,e);if(a.hasClass("ce_inline_editor")){var f=a.control().child.attr("id");"undefined"!==typeof f&&(f=tinymce.get(f),"undefined"!==typeof f&&f.destroy())}a.remove();
var f=CE.DragDrop.myThis.clearIfEmpty(b,"remove"),g=!1;f&&f.hasOwnProperty("row")&&(g=!0,b=f.row);CE.DragDrop.myThis.isEmptyScene()&&(c(".motopress-handle-middle-in").remove(),CE.DragDrop.myThis.emptySceneHelper.show(),CE.Utils.addSceneState("empty-scene"));g||CE.DragDrop.myThis.resize(b,a,"remove",e);CE.Resizer.myThis.updateSplittableOptions(null,b,null);CE.Resizer.myThis.updateAllHandles();c(window).trigger("resize");var l,h={involvedElements:{}};d.length&&(a=d.find(".motopress-block-content > [data-motopress-shortcode]"),
a.length&&a.each(function(){l=c(this).attr("data-motopress-shortcode");h.involvedElements.hasOwnProperty(l)||(h.involvedElements[l]=[]);h.involvedElements[l].push(this)}));c("body").trigger("MPCEObjectRemove",h)},cloneShortcodes:function(a){var b="";a.hasClass("motopress-row")||a.hasClass("motopress-clmn")||(b=parent.CE.Save.getShortcode(b,a));var d=c.Deferred();c.ajax({url:parent.motopress.ajaxUrl,type:"POST",dataType:"html",data:{action:"motopress_ce_render_shortcodes_string",nonce:parent.motopressCE.nonces.motopress_ce_render_shortcodes_string,
postID:parent.motopressCE.postID,content:b},success:function(a){d.resolve(a)},error:function(a){a=c.parseJSON(a.responseText);d.reject(a);a.debug?console.log(a.message):(parent.MP.Flash.setFlash(a.message,"error"),parent.MP.Flash.showMessage())}});return d.promise()}})}(jQuery),function(c){CE.Resizer=can.Construct({myThis:null},{minHeight:30,minWidth:8,spaceMinHeight:10,gmapMinHeight:150,handle:null,addedStyleProperties:"position top left width height background-position background-repeat".split(" "),
emptySpan:null,gridColumnSizeClassesString:"",splitter:c("<div />",{"class":"motopress-splitter"}),oldWidth:null,emptySpanNumber:0,resizeWindowTimer:null,container:c("#motopress-container"),bodyEl:c("body"),setup:function(){this.setGridColumnSizeClassesString();this.setEmptySpan()},init:function(){CE.Resizer.myThis=this;CE.Grid.myThis.padding&&this.splitter.css({width:2*CE.Grid.myThis.padding,"margin-left":-2*CE.Grid.myThis.padding});c(window).on("resize",function(a){parent.CE.Iframe.myThis.setSceneWidth();
a.target===this&&CE.Resizer.myThis.proxy("updateHandle");CE.Resizer.myThis.resizeWindowTimer&&clearTimeout(CE.Resizer.myThis.resizeWindowTimer);CE.Resizer.myThis.resizeWindowTimer=setTimeout(function(){parent.MP.Editor.triggerIfr("Resize")},500)});parent.MP.Editor.onIfr("Resize",function(a){CE.Resizer.myThis.updateAllHandles()})},setGridColumnSizeClassesString:function(){for(var a=[],b=1;b<=parent.CE.Iframe.myThis.gridObj.row.col;b++)a.push(parent.CE.Iframe.myThis.gridObj.span["class"]+b);this.gridColumnSizeClassesString=
a.join(" ")},setEmptySpan:function(){var a=c(parent.motopressCE.rendered_shortcodes.empty[parent.CE.Iframe.myThis.gridObj.span.shortcode]);CE.DragDrop.setEdgeSpan(a,!0);a.find(".motopress-filler-content").remove();a.removeClass(this.gridColumnSizeClassesString);CE.LeftBar.myThis.setAttrs(a,CE.LeftBar.myThis.library.mp_grid.id,CE.LeftBar.myThis.library.mp_grid.objects[parent.CE.Iframe.myThis.gridObj.span.shortcode]);this.emptySpan=a},getMinHeight:function(a){var b=a.find(".motopress-block-content > [data-motopress-shortcode]");
return b.length&&"mp_gmap"===b.attr("data-motopress-shortcode")?this.gmapMinHeight:a.hasClass(CE.DragDrop.myThis.spaceClass)?this.spaceMinHeight:this.minHeight},makeResizable:function(a){var b=this;a.not("[data-motopress-wrapper-id], .motopress-empty").each(function(){var a=c(this).find(".motopress-block-content > [data-motopress-shortcode]"),e=a.length?a.attr("data-motopress-shortcode"):null,f;c(this).resizable({grid:[1,10],handles:"e, s, w, se, sw",helper:"motopress-resizer-helper",minWidth:2,minHeight:CE.Resizer.myThis.getMinHeight(c(this)),
zIndex:1002,create:function(){c(this).resizable("option","maxWidth",parseFloat(c(this).css("width")));c(this).children(".ui-resizable-handle").hide();var a=CE.Grid.myThis.padding-4;c(this).children(".ui-resizable-e, .ui-resizable-se").css("right",a);c(this).children(".ui-resizable-w, .ui-resizable-sw").css("left",a)},start:function(g,h){CE.Utils.addSceneAction("resize");CE.LeftBar.myThis.disable();CE.LeftBar.myThis.hide();b.hideSplitters();b.hideEmptySpans();c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height("");
c(this).find(".motopress-handle-bottom-in").css({bottom:"",height:""});CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close");CE.Resizer.myThis.handle=c(g.originalEvent.target);b.oldWidth=parseFloat(h.element.css("width"));f=parent.MP.Utils.getHandleClass(CE.Resizer.myThis.handle.prop("class").split(" "));var m=null,m="ui-resizable-e"===f||"ui-resizable-se"===f?h.element.next(".motopress-empty"):h.element.prev(".motopress-empty"),k=parent.MP.Utils.getSpanClass(h.element.prop("class").split(" ")),
k=parent.MP.Utils.getSpanNumber(k);b.oldSpanNumber=k;var q=0;m&&m.length&&(m=parent.MP.Utils.getSpanClass(m.prop("class").split(" ")),q=parent.MP.Utils.getSpanNumber(m));m=k+q;CE.Resizer.myThis.maxSpanNumber=m;var n=c(this).parent(".motopress-row-edge").width()/100;h.element.resizable("option","maxWidth",n*CE.Grid.myThis.colWidthByNumber[m]);k=[];for(q=1;q<=m;q++)k[q]=n*CE.Grid.myThis.colWidthByNumber[q];for(var n=Math.floor(m/2),p=0===m%2,q=1;q<=n;q++)0>k[q]-2*CE.Grid.myThis.padding&&(k[q]*=-1,p?
q!==n&&(k[m-q]*=-1):k[m-q]*=-1);h.element.data("mp-snap-grid",k);CE.Resizer.myThis.handle.addClass("motopress-resizable-handle-hover");h.element.css({position:"relative",top:0,left:0});c(this).closest(".motopress-row").parent(".motopress-content-wrapper").length||(m=c(this).closest(".motopress-row").nextAll(".motopress-handle-middle-in:last"),k=parseInt(m.css("min-height")),m.height(k));c("body").trigger("MPCEObjectResizeStart",{objElement:a,objName:e,handle:f})},stop:function(g,h){CE.Utils.removeSceneAction("resize");
CE.LeftBar.myThis.enable();CE.LeftBar.myThis.show();b.showSplitters();b.showEmptySpans();CE.Resizer.myThis.splitterHandle=!1;CE.Resizer.myThis.handle.removeClass("motopress-resizable-handle-hover");for(var m={},k=0;k<CE.Resizer.myThis.addedStyleProperties.length;k++)m[CE.Resizer.myThis.addedStyleProperties[k]]="";h.element.css(m);c(this).hasClass("ce_controls")&&!CE.Dialog.myThis.element.dialog("isOpen")&&(m=h.element.find(".motopress-drag-handle"),CE.Dialog.myThis.open(m));m=h.element.prev(".motopress-empty");
k=h.element.next(".motopress-empty");CE.DragDrop.myThis.makeEditableEmptySpan(m.add(k));b.updateSplittableOptions(m,null,null);b.updateSplittableOptions(k,null,null);CE.Resizer.myThis.updateAllHandles();parent.CE.Save.changeContent();c("body").trigger("MPCEObjectResizeStop",{objElement:a,objName:e,handle:f})},resize:function(b,g){switch(f){case "ui-resizable-s":CE.Resizer.myThis.verticalResize(g);break;case "ui-resizable-w":CE.Resizer.myThis.horizontalResize(f,g);break;case "ui-resizable-e":CE.Resizer.myThis.horizontalResize(f,
g);break;case "ui-resizable-sw":CE.Resizer.myThis.verticalResize(g);CE.Resizer.myThis.horizontalResize(f,g);break;case "ui-resizable-se":CE.Resizer.myThis.verticalResize(g),CE.Resizer.myThis.horizontalResize(f,g)}c("body").trigger("MPCEObjectResize",{objElement:a,objName:e,handle:f})}});if(a.length){var g=a.attr("data-motopress-resize");"undefined"===typeof g&&(g=a.attr("data-motopress-group"),g=CE.LeftBar.myThis.library[g].objects[e].resize);switch(g){case "none":c(this).children(".ui-resizable-handle").addClass("motopress-hide");
break;case "horizontal":c(this).children('.ui-resizable-handle:not(".ui-resizable-e, .ui-resizable-w")').addClass("motopress-hide");break;case "vertical":c(this).children('.ui-resizable-handle:not(".ui-resizable-s")').addClass("motopress-hide")}}})},horizontalResize:function(a,b){var c=parseFloat(b.helper.css("width"));b.element.css({top:0,left:0});if(c===this.oldWidth)return!1;for(var e=c<this.oldWidth?-1:1,f=b.element.data("mp-snap-grid"),g=f.length-1,l=!1,h=1;h<=g;h++)if(!(0>=f[h])&&(l=1===h?0>
e?f[h]:Math.abs(f[h+1])-Math.abs(f[h]):h==g?Math.abs(f[h])-Math.abs(f[h-1]):0>e?Math.abs(f[h])-Math.abs(f[h-1]):Math.abs(f[h+1])-Math.abs(f[h]))&&(l=Math.abs(l)/2,c>=f[h]-l/2&&c<=f[h]+l&&(l=h-this.oldSpanNumber,0!==l))){e=null;parent.MP.Utils.getSpanClass(b.element.prop("class").split(" "));CE.Resizer.myThis.changeSpanClass(b.element,parent.CE.Iframe.myThis.gridObj.span["class"]+h);"ui-resizable-e"===a||"ui-resizable-se"===a?(f="east",e=b.element.next(".motopress-empty")):(f="west",e=b.element.prev(".motopress-empty"));
e&&e.length?(f=parent.MP.Utils.getSpanClass(e.prop("class").split(" ")),f=parent.MP.Utils.getSpanNumber(f),l<f?CE.Resizer.myThis.changeSpanClass(e,parent.CE.Iframe.myThis.gridObj.span["class"]+(f-l)):e.remove()):(e=CE.Resizer.myThis.emptySpan.clone(),e.addClass(parent.CE.Iframe.myThis.gridObj.span["class"]+Math.abs(l)).addClass("motopress-empty-hide"),"east"===f?b.element.after(e):b.element.before(e));b.element.css({width:""});this.oldWidth=c;this.oldSpanNumber=h;break}return!1},verticalResize:function(a){var b=
parseInt(a.element.css("min-height")),c=a.helper.height();b===c&&a.element.css("min-height","");a.element.css("min-height",c);a.element.css("height",c)},getMinChildColumn:function(a){var b=CE.Grid.myThis.columnCount;a.find(".motopress-clmn").each(function(){var a=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(c(this).prop("class").split(" ")));a<b&&(b=a)});return b},isAllowedColSize:function(a,b){return 0>b/100*CE.Grid.myThis.colWidthByNumber[a]-2*CE.Grid.myThis.padding?!1:!0},makeSplittable:function(a){if(!a.length)return!1;
var b=this,d,e,f;(a.hasClass("motopress-splitter")?a:a.find(".motopress-splitter")).draggable({axis:"x",cursor:"col-resize",grid:[1,0],helper:"clone",zIndex:1,start:function(a,e){CE.Utils.addSceneAction("split");e.helper.hide();b.hideSplitters(c(this));b.hideEmptySpans();c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height("");d=null;f=!1;CE.LeftBar.myThis.disable();CE.LeftBar.myThis.hide();c(this).addClass("motopress-splitter-hover");CE.Dialog.myThis.element.dialog("isOpen")&&
CE.Dialog.myThis.element.dialog("close");var h=e.helper.closest(".motopress-row");h.find(".motopress-drag-handle").css("cursor","col-resize");var m=parent.MP.Utils.getEdgeRow(h).width()/100,k=c(this).closest(".motopress-clmn"),h=k.prev(".motopress-clmn"),q=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(k.prop("class").split(" "))),n=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(h.prop("class").split(" "))),p=h.offset().left;if(h.is("[data-motopress-wrapper-id]"))var r=b.getMinChildColumn(h);
if(k.is("[data-motopress-wrapper-id]"))var t=b.getMinChildColumn(k);for(var u=q+n-1,v=[],s=1;s<=u;s++)v[s]=m*CE.Grid.myThis.colWidthByNumber[s];for(var m=v.slice(),x,s=1;s<n;s++)0>v[s]-2*CE.Grid.myThis.padding?v[s]=-1*(p+v[s]):(x=1,u=Math.abs(v[s]),0<v[s]&&h.is("[data-motopress-wrapper-id]")&&(b.isAllowedColSize(r,u)||(x=-1)),v[s]=(p+v[s])*x);r=n-1;for(s=q;1<=s;s--)r++,0>m[s]-2*CE.Grid.myThis.padding?v[r]=-1*(p+v[r]):(x=1,u=m[s],0<m[s]&&k.is("[data-motopress-wrapper-id]")&&(b.isAllowedColSize(t,u)||
(x=-1)),v[r]=(p+v[r])*x);c(this).data("mp-snap-grid",v);b.currentI=n;b.curSplitterArea="";var y,z={involvedElements:{}};k.length&&(t=k.find(".motopress-block-content > [data-motopress-shortcode]"),t.length&&t.each(function(){y=c(this).attr("data-motopress-shortcode");z.involvedElements.hasOwnProperty(y)||(z.involvedElements[y]=[]);z.involvedElements[y].push(this)}));h.length&&(t=h.find(".motopress-block-content > [data-motopress-shortcode]"),t.length&&t.each(function(){y=c(this).attr("data-motopress-shortcode");
z.involvedElements.hasOwnProperty(y)||(z.involvedElements[y]=[]);z.involvedElements[y].push(this)}));c("body").trigger("MPCEObjectSplitStart",z)},stop:function(a,d){CE.Utils.removeSceneAction("split");CE.LeftBar.myThis.enable();CE.LeftBar.myThis.show();b.showSplitters();b.showEmptySpans();d.helper.closest(".motopress-row").find(".motopress-drag-handle").css("cursor","move");c(this).removeClass("motopress-splitter-hover");var h=c(this).closest(".motopress-clmn"),m=h.prev(".motopress-clmn");CE.Resizer.myThis.updateSplittableOptions(h,
null,null,"split");CE.Resizer.myThis.updateAllHandles();f&&e.length&&e.remove();parent.CE.Save.changeContent();var k,q={involvedElements:{}};h.length&&(h=h.find(".motopress-block-content > [data-motopress-shortcode]"),h.length&&h.each(function(){k=c(this).attr("data-motopress-shortcode");q.involvedElements.hasOwnProperty(k)||(q.involvedElements[k]=[]);q.involvedElements[k].push(this)}));m.length&&(h=m.find(".motopress-block-content > [data-motopress-shortcode]"),h.length&&h.each(function(){k=c(this).attr("data-motopress-shortcode");
q.involvedElements.hasOwnProperty(k)||(q.involvedElements[k]=[]);q.involvedElements[k].push(this)}));c("body").trigger("MPCEObjectSplitStop",q)},drag:function(a,l){var h=!1,m=l.offset.left-CE.Grid.myThis.padding/2;null===d&&(d=m);if(m!==d){var k=c(this).closest(".motopress-clmn"),q=null,n=k.closest(".motopress-row-edge").width(),p,r,t=c(this).data("mp-snap-grid"),u=t.length-1;1<u?(p=Math.abs(t[2])-Math.abs(t[1]),r=Math.abs(t[u])-Math.abs(t[u-1])):p=r=n/100*CE.Grid.myThis.colWidthByNumber[1];p>CE.Grid.myThis.padding&&
(p-=CE.Grid.myThis.padding);p>CE.Grid.myThis.padding&&(p-=CE.Grid.myThis.padding);r>CE.Grid.myThis.padding&&(r-=CE.Grid.myThis.padding);p=2>=a.pageX||m<=Math.abs(t[1])-p;r=a.pageX>=c(document).width()-2||m>=Math.abs(t[u])+1.5*r;if(p||r){if(p&&"left"===b.curSplitterArea||r&&"right"===b.curSplitterArea)return;q=k.prev(".motopress-clmn");m=parent.MP.Utils.getSpanClass(k.prop("class").split(" "));n=parent.MP.Utils.getSpanClass(q.prop("class").split(" "));m=parent.MP.Utils.getSpanNumber(m);n=parent.MP.Utils.getSpanNumber(n);
if(p)if(b.curSplitterArea="left",q.hasClass("motopress-empty"))CE.Resizer.myThis.changeSpanClass(k,parent.CE.Iframe.myThis.gridObj.span["class"]+(m+n)),e=q,f=!0,c(window).trigger("resize"),h=!0;else{m=0;for(p=1;p<=u;p++)if(0<t[p]){m=p;break}m&&(CE.Resizer.myThis.changeSpanClass(k,parent.CE.Iframe.myThis.gridObj.span["class"]+(u+1-m)),CE.Resizer.myThis.changeSpanClass(q,parent.CE.Iframe.myThis.gridObj.span["class"]+m),b.currentI=m,c(window).trigger("resize"),h=!0)}else if(b.curSplitterArea="right",
k.hasClass("motopress-empty"))CE.Resizer.myThis.changeSpanClass(q,parent.CE.Iframe.myThis.gridObj.span["class"]+(n+m)),e=k,f=!0,c(window).trigger("resize"),h=!0;else{m=0;for(p=u;1<=p;p--)if(0<t[p]){m=p;break}m&&(CE.Resizer.myThis.changeSpanClass(k,parent.CE.Iframe.myThis.gridObj.span["class"]+(u+1-m)),CE.Resizer.myThis.changeSpanClass(q,parent.CE.Iframe.myThis.gridObj.span["class"]+m),b.currentI=m,c(window).trigger("resize"),h=!0)}}else{b.curSplitterArea="center";var v=m<d?-1:1;r=!1;for(p=1;p<=u;p++)if(!(0>=
t[p])&&(r=!1,r=1<u?1===p?Math.abs(t[p+1])-Math.abs(t[p]):p==u?Math.abs(t[p])-Math.abs(t[p-1]):0>v?Math.abs(t[p])-Math.abs(t[p-1]):Math.abs(t[p+1])-Math.abs(t[p]):n/100*CE.Grid.myThis.colWidthByNumber[1])&&(r=Math.abs(r)/2,m>=t[p]-r/2&&m<=t[p]+r&&(r=p-b.currentI,f=!1,0!==r))){k=c(this).closest(".motopress-clmn");q=k.prev(".motopress-clmn");m=parent.MP.Utils.getSpanClass(k.prop("class").split(" "));n=parent.MP.Utils.getSpanClass(q.prop("class").split(" "));n=parent.MP.Utils.getSpanClass(q.prop("class").split(" "));
m=parent.MP.Utils.getSpanNumber(m);n=parent.MP.Utils.getSpanNumber(n);h=n+r;CE.Resizer.myThis.changeSpanClass(k,parent.CE.Iframe.myThis.gridObj.span["class"]+(m-r));CE.Resizer.myThis.changeSpanClass(q,parent.CE.Iframe.myThis.gridObj.span["class"]+h);b.currentI=p;c(window).trigger("resize");h=!0;break}}k&&k.length&&(t=parseInt(k.css("margin-top"))+parseInt(k.css("border-top-width")),u=c(this).closest(".motopress-row").height(),c(this).css({top:-t,height:u}),f&&a.preventDefault());if(h){CE.Resizer.myThis.updateSplitterHeight();
var s,x={involvedElements:{}};k&&k.length&&(k=k.find(".motopress-block-content > [data-motopress-shortcode]"),k.length&&k.each(function(){s=c(this).attr("data-motopress-shortcode");x.involvedElements.hasOwnProperty(s)||(x.involvedElements[s]=[]);x.involvedElements[s].push(this)}));q&&q.length&&(k=q.find(".motopress-block-content > [data-motopress-shortcode]"),k.length&&k.each(function(){s=c(this).attr("data-motopress-shortcode");x.involvedElements.hasOwnProperty(s)||(x.involvedElements[s]=[]);x.involvedElements[s].push(this)}));
c("body").trigger("MPCEObjectSplit",x)}}}})},calcSplitterOptions:function(a,b){var d=null,e=null,f=null;if("column"===b)e=a.parent(".motopress-row-edge").width(),d=a;else if("row"===b)d=parent.MP.Utils.getEdgeRow(a),e=d.width(),d=d.children(".motopress-clmn");else return!1;if(!CE.Grid.myThis.padding)var e=e/100,g=e*CE.Grid.myThis.columnMarginPiece,l=e*CE.Grid.myThis.splitterWidthPiece+g,h=-(e*CE.Grid.myThis.splitterMarginPiece+g/2);d.each(function(){f=c(this).find(".motopress-helper > .motopress-splitter");
...
c(this).hasClass("motopress-wrapper-helper");c(this).find(".motopress-handle-left, .motopress-handle-right").each(function(){var d=c(this).hasClass("motopress-handle-left")?"left":"right",g=parseFloat(e.css("border-"+d+"-width")),h="left"===d?e.offset().left-0:c(window).width()-e.offset().left-e.outerWidth(),k=h+g+CE.Grid.myThis.padding;0>=Math.floor(k)&&(k=25,h=0);k={top:-f,width:k,height:b};k[d]=-(a?h+g:h+g+CE.Grid.myThis.padding);c(this).css(k)})})})});var l=c("html"),h=c(document),m=h.width()-
0,k=c(".motopress-content-wrapper > .motopress-handle-middle-in:first"),q=c(".motopress-content-wrapper > .motopress-handle-middle-in:last"),n=q.prevAll(".motopress-handle-middle-in:first");n[0]!==k[0]&&n.css({width:"",left:"",height:"","margin-top":""});var n=h.height(),p=parseInt(l.css("top")),l=n-q.offset().top;n<p+h.outerHeight(!0)&&(l+=p);f=parseInt(f.css("margin-bottom"));Math.abs(parseInt(q.css("margin-top")))!==f&&(l+=f);b=parseInt(b.css("margin-top"));k.css({width:m,height:d.top,top:b-d.top,
left:-g+e,"margin-top":""});q.css({width:m,left:-g+e,height:l,"margin-top":-f})}clearTimeout(a)},50)},updateBottomInHandleMiddle:function(){var a=setTimeout(function(){CE.DragDrop.myThis.isEmptyScene()||c(".motopress-content-wrapper > .motopress-row").each(function(){CE.Resizer.myThis.setHandleHeight(c(this))});clearTimeout(a)},50)},setHandleHeight:function(a){var b=parseInt(a.find(".motopress-handle-middle-in:last").css("min-height"));a.find(".motopress-handle-middle-in").each(function(){c(this).height(b)});
parent.MP.Utils.getEdgeRow(a).children('.motopress-clmn:not(".motopress-empty")').each(function(){var b=c(this),e=parent.MP.Utils.getEdgeSpan(b),f=e.width(),g=e.children(".motopress-row"),l=a.is(":last-of-type")?0:5,h=a.is(":first-of-type")?0:5,m=e.offset().top+e.outerHeight(),k=a.offset().top+a.outerHeight();g.length?(h=e.children(".motopress-handle-middle-in:last-of-type"),b=k-m,l=h.prev(".motopress-row"),l=l.offset().top+l.outerHeight(),m=parseFloat(h.css("min-height")),h.css({bottom:-b+m,height:k-
l,width:f}),k=e.children(".motopress-handle-middle-in:first-of-type"),h=parseFloat(e.css("padding-top")),b=parseFloat(e.css("border-top")),e=e.offset().top-a.offset().top,l=parseFloat(k.css("min-height")),k.css({top:-e-b,height:e+b+h+l,width:f}),g.each(function(){CE.Resizer.myThis.setHandleHeight(c(this))})):(f=b.find(".motopress-handle-bottom-in"),g=parseFloat(f.css("min-height")),m=e.offset().top+e.outerHeight(),k=a.offset().top+a.outerHeight(),k=m-k,f.css({bottom:l+k,height:g-k+parseFloat(e.css("border-bottom-width"))}),
f=e.offset().top-a.offset().top,g=b.find(".motopress-handle-top-in"),k=parseInt(g.css("min-height")),g.css({top:h-f,height:k+f+parseFloat(e.css("border-top-width"))}))})},updateHandleMiddle:function(){var a=setTimeout(function(){c('.motopress-content-wrapper > .motopress-handle-middle-in:not(":first-of-type, :last-of-type"), .motopress-content-wrapper .motopress-row-edge > .motopress-clmn .motopress-handle-middle-in:not(":first-of-type, :last-of-type")').each(function(){var a=c(this),d=a.prev(".mpce-wp-more-tag").length?
