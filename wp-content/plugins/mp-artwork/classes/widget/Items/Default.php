 ...
 * @abstract 
 */
abstract class MP_Artwork_Plugin_Widget_Default extends WP_Widget {
    ...
    function __construct() {
        if (!defined('THEMENAMEARTWORK')) {
            define('THEMENAMEARTWORK', 'Artwork');
        }
        $this->setPrefix('mp-artwork');
        $this->setTextdomain('mp-artwork');
    ...
    protected function getTranslatedName() {
        return THEMENAMEARTWORK . $this->getNameDelimiter() . $this->getName();
    }
